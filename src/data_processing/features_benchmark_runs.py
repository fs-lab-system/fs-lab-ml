...
def build_service_features(aggregates: Dict[str, Dict[str, Any]]):
    ...
    for service, service_aggregate in aggregates.items():
        p50 = service_aggregate["p50_latency_s"]
        p95 = service_aggregate["p95_latency_s"]
        p99 = service_aggregate["p99_latency_s"]
        ...
        features[service] = {
            ...
            "success_rate": service_aggregate["success_rate"],
        }
