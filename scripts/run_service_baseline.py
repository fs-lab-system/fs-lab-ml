...
from src.decision_logic.service_baseline import decide_service_health
import json

if __name__ == "__main__":
    # ingestion phase
    fetch_result = fetch_benchmark_runs(limit=200)
    ...
    # simple decisions ahead of ML
    decisions = decide_service_health(features["data"]["by_service"])
